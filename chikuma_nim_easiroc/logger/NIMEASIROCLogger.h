...
#ifndef NIMEASIROCLOGGER_H
#define NIMEASIROCLOGGER_H
...
class NIMEASIROCLogger
    : public DAQMW::DaqComponentBase
{
public:
    NIMEASIROCLogger(RTC::Manager* manager);
    virtual ~NIMEASIROCLogger();
